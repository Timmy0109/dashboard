<template>
  <div>
    <div class="mb-6 flex items-center justify-between">
      <div>
        <h2 class="text-xl font-bold text-gray-900">公司管理</h2>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <table v-else class="w-full">
        ...
        <tbody class="divide-y divide-gray-50">
          <tr v-for="company in store.list" :key="company.id" class="hover:bg-gray-50">
            ...
            <td class="px-4 py-3">
              <div class="flex gap-1">
                <button
                  ...
                  title="功能設定"
                ><span class="material-icons text-base leading-none">tune</span></button>
                <button
                ...
                ><span class="material-icons text-base leading-none">{{ company.status === 'active' ? 'block' : 'check_circle' }}</span></button>
              </div>
            </td>
          </tr>
